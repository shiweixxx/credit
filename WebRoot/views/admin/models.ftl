      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">         
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">模型选择</h2>
                  ...
                  <div class="col-1">
                    <div id="gauge_div" class="templatemo-chart">
                            <div class="templatemo-content-widget white-bg">
                                    ...
                                    <p class="margin-bottom-0"><font color='black'>当前特征：性别，行业，年龄等</font></p> 
                                    <p class="margin-bottom-0"><font color='black'>选取数据 : 人工标记数据/机器统计数据 </font></p> 
                                    <p class="margin-bottom-0"><font color='black'>样本选取样本数量：1000个样本</font></p> 
                                    <p class="margin-bottom-0"><font color='black'>正/负样本比例：1:1</font></p>   
                                    ...
                                    <p class="margin-bottom-0"><font color='blue'><a href="#">模型迭代</a></font></p>
                             </div>                        
                    </div>                
                  </div> 
                  <!-- end model1 -->
              ...
              <div class="panel-body">
                ...
                <!-- model1 start -->
                  <div class="col-1">
                    <div id="gauge_div" class="templatemo-chart">
                            <div class="templatemo-content-widget white-bg">
                                     <p class="margin-bottom-0"><font color='black'>当前特征： </font></p> 
